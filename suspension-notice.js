...
(function () {
  ...
  var css = '' +
    ...
    '.ntcpop__card { position: relative; width: 100%; max-width: 480px; max-height: 92vh; overflow-y: auto; background: #021922; color: #fff; border-radius: 18px; border-top: 4px solid #debc6b; box-shadow: 0 30px 80px rgba(0, 0, 0, 0.55), 0 0 0 1px rgba(222, 188, 107, 0.15); transform: translateY(14px) scale(0.98); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1); font-family: "Manrope", system-ui, sans-serif; -webkit-overflow-scrolling: touch; overflow-anchor: none; }' +
    ...
    '.ntcpop__scrollhint { position: sticky; bottom: 104px; height: 0; display: flex; justify-content: center; z-index: 4; pointer-events: none; opacity: 1; transition: opacity 0.35s ease; }' +
    '.ntcpop__scrollhint.is-hidden { opacity: 0; }' +
    '.ntcpop__scrollhint span { display: inline-flex; align-items: center; gap: 7px; background: rgba(2, 25, 34, 0.88); border: 1px solid rgba(222, 188, 107, 0.55); color: #debc6b; font-size: 0.7rem; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; padding: 7px 15px; border-radius: 999px; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.4); animation: ntcpopBounce 1.6s ease-in-out infinite; }' +
    '@keyframes ntcpopBounce { 0%, 100% { transform: translateY(-46px); } 50% { transform: translateY(-38px); } }' +
  ...
  var html = '' +
    ...
    '    <img src="/images/notice-slide-1.jpg" width="1100" height="1128" alt="We\'re sorry. An important update about our jet ski rides." />' +
    '    <img src="/images/notice-slide-2.jpg" width="1100" height="1256" loading="lazy" alt="Jet ski rentals are temporarily paused due to circumstances outside of our control involving the permitting process." />' +
    '    <img src="/images/notice-slide-3.jpg" width="1100" height="1193" loading="lazy" alt="We know this is disappointing. We are truly sorry we cannot provide the famous 6-Mile Ride experience this summer." />' +
    '    <img src="/images/notice-slide-4.jpg" width="1100" height="1259" loading="lazy" alt="The good news: private pontoon boat rentals remain open. Call 410-629-7433 to reserve." />' +
    '    <img src="/images/notice-slide-5.jpg" width="1100" height="1223" loading="lazy" alt="Thank you to everyone who has supported OCA. Voted number 1 best jet ski rentals in Ocean City 2026." />' +
    '    <img src="/images/notice-slide-6.jpg" width="1100" height="1250" loading="lazy" alt="We are actively exploring every option, including an immediate temporary solution for this season. Check our website and social pages for updates." />' +
    '    <img src="/images/notice-slide-7.jpg" width="1100" height="1256" loading="lazy" alt="This isn\'t goodbye. Call 410-629-7433 or visit OCAWatersports.com. Thank you for standing with the OCA Watersports family." />' +
    '  </div>' +
    '  <div class="ntcpop__scrollhint" aria-hidden="true"><span>Scroll for more &darr;</span></div>' +
  ...
  function init() {
    ...
    // Fade the scroll hint once the visitor starts scrolling the slides.
    var card = pop.querySelector('.ntcpop__card');
    var hint = pop.querySelector('.ntcpop__scrollhint');
    if (card && hint) {
      card.addEventListener('scroll', function () {
        if (card.scrollTop > 60) { hint.classList.add('is-hidden'); }
      }, { passive: true });
    }
